...
export function PublicEmbeddedFrame(props: PublicEmbeddedFrameProps) {
  ...
  const sandbox = useMemo(() => {
    const baseSandbox = getPublicEmbeddedFrameSandbox(src)
    return props.allowTopNavigationByUserActivation
      ? `${baseSandbox} allow-top-navigation-by-user-activation`
      : baseSandbox
  }, [props.allowTopNavigationByUserActivation, src])
